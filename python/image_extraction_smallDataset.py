...
def extraction(bag_file,image_topic,output_dir, ts_start, ts_stop, compressed=True):
    ...
    df.to_csv(os.path.join(output_dir, "mav0/cam0/data_small_v2.csv"), index=False)
    return
...
extraction(bag_file='/media/yanhao/8tb1/00_data_TII/island_localization/cv-assignment-1.bag',
           ...
           output_dir='/media/yanhao/8tb1/00_data_TII/island_localization/frames',
           ts_start=1683701470.0,
