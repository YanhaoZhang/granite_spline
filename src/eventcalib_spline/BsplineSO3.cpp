...
granite::BsplineSO3::BsplineSO3(int p,
...
void granite::BsplineSO3::knotSpacing(int controlPointsNum) {
...
void granite::BsplineSO3::derBasisFuns(double u, size_t spanIdx, int derivativeLimit,
...
void granite::BsplineSO3::basis(double u, size_t spanIdx, int derivativeLimit, int degree,
                                std::vector<std::vector<double>> &ders) const {
    ders.resize(derivativeLimit + 1);
    for (auto &it:ders) {
...
void granite::BsplineSO3::initialGuess() {
    /*** check ***/
    if (samples_.empty()) {
...
void granite::BsplineSO3::optimizeCP() {
...
void granite::BsplineSO3::evaluate(double u, int derivativeLimit, Sophus::SO3d &val,
